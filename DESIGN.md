...
Synthesized from 10+ expert trader transcripts covering momentum, volume profile,
order flow, risk management, and market regime detection.
...
│   │   ├── mod.rs
│   │   ├── kraken.rs             # Kraken REST + WebSocket v2 client
│   │   ├── market_data.rs        # OHLCV candle management
│   │   ├── orderbook.rs          # Order book depth processing
│   │   └── indicators.rs         # EMA, RSI, ATR, VWAP, Volume Profile
