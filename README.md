...
│   ├── engine/
│   │   ├── mod.rs                    # EngineState + main trading loop (4,653 lines)
│   │   ├── training.rs               # Training, sandbox, live test (1,846 lines)
│   │   ├── debug.rs                  # Dry-run, live test (407 lines)
│   │   └── utils.rs                  # Shared utilities (200 lines)
...
- Active FIDs: FID-106 through FID-117 (FID-111 Position-Pair Injection, FID-112 Side Correction, FID-116 Chain-Only Truth, FID-117 Journal as Single Source of Truth)
- 121+ archived FIDs
