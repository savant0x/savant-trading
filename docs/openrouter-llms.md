...
> For a complete documentation index, see https://openrouter.ai/docs/quickstart/llms.txt.
> For AI client integration (Claude Code, Cursor, etc.), connect to the MCP server at https://openrouter.ai/docs/quickstart/_mcp/server.
