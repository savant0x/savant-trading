...
pub const ETHEREUM_TOKENS: &[(&str, &str, u8)] = &[
    ...
    ("DAI", "0x6B175474E89094C44Da98b954EeE6C23E20D6", 18),
...
pub const BASE_TOKENS: &[(&str, &str, u8)] = &[
    ...
    // FID-093 C10: UNSUPPORTED — Base chain AAVE address is placeholder
    ("AAVE", "UNSUPPORTED_BASE_CHAIN", 18),
    ("PEPE", "0x6982508145454Ce325dDbE47a25d4ec3d2311933", 18),
    // FID-093 C10: UNSUPPORTED — Base chain PENDLE address is placeholder
    ("PENDLE", "UNSUPPORTED_BASE_CHAIN", 18),
    ("COMP", "0x9e1028F5F1D5eDE59748FFceE5532509976840E0", 18),
    // FID-093 C10: UNSUPPORTED — Base chain LDO address is placeholder
    ("LDO", "UNSUPPORTED_BASE_CHAIN", 18),
    ("DAI", "0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb", 18),
    // FID-093 C10: UNSUPPORTED — Base chain ARB address is placeholder
    ("ARB", "UNSUPPORTED_BASE_CHAIN", 18),
...
pub const OPTIMISM_TOKENS: &[(&str, &str, u8)] = &[
    ...
    ("DAI", "0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1", 18),
    // FID-093 C10: UNSUPPORTED — Optimism ARB address is placeholder
    ("ARB", "UNSUPPORTED_OPTIMISM_CHAIN", 18),
