...
//! alternative.me, blockchain.info, RSS feeds, CoinMetrics).
//!
...
//! - `onchain` — On-chain analytics: MVRV, NUPL, SOPR, NVT (CoinMetrics)
//! - `news` — RSS feeds (15 sources) + CoinGecko trending
