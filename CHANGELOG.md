...
- **Console color inconsistency (FID-032)** — RESET between sections killed bold, result color bled to next line. Rewrote `savant_log()` with compound ANSI codes, single RESET at end, pair name highlighting.
